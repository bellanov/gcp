...
class TestFolder:
    ...
    def test_folder_valid_creation(self):
        ...
        folder = Folder(name="folders/123456", display_name="My Folder", parent="folders/123456")
    ...
    def test_folder_valid_id_lowercase(self):
        ...
        folder = Folder(name="folders/123456", display_name="Test Folder", parent="folders/123456")
        assert folder.name == "folders/123456"

    def test_folder_valid_id_with_numbers(self):
        """Test folder with numbers in ID."""
        folder = Folder(name="folders/123456", display_name="Folder 123 ABC", parent="folders/123456")
        assert folder.name == "folders/123456"

    def test_folder_valid_id_with_hyphens(self):
        """Test folder with hyphens in ID."""
        folder = Folder(name="folders/123456", display_name="My Test Folder", parent="folders/123456")
        assert folder.name == "folders/123456"

    def test_folder_valid_id_with_underscores(self):
        """Test folder with underscores in ID."""
        folder = Folder(name="folders/123456", display_name="My Folder Name", parent="folders/123456")
        assert folder.name == "folders/123456"
    ...
    def test_folder_valid_single_word_id(self):
        ...
        folder = Folder(name="folders/123456", display_name="Folder", parent="folders/123456")
        assert folder.name == "folders/123456"
    ...
    def test_folder_name_invalid_special_chars(self):
        ...
        with pytest.raises(ValidationError):
            Folder(name="folders/123456()", display_name="My Folder", parent="folders/123456")
